...
public class StudentService {
    ...
    public String update(StudentMobUpdateDto studentMobUpdateDto){
        //fetching the original data
        Student original=studentRepository.findById(studentMobUpdateDto.getId()).get();
        //keep the other attributes as it is and change the required parameters
        original.setMobNo(studentMobUpdateDto.getMobNo());
        studentRepository.save(original);
        return "student mobNo updated successfully";
        /*
    1. Existing Functions with no definition.
    2. Existing function + with defining.
    3. New Function with custom jpa query
 */
